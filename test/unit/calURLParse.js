...
describe('calURLParse', function () {
  it('should handle the base /cal route', function () {
    expect(parse('/cal')).to.equal('./node-cal/node-cal.js');
  });

  it('should handle a full year route', function () {
    expect(parse('/cal/2015')).to.equal('./node-cal/node-cal.js 2015');
    expect(parse('/cal/9999999')).to.equal('./node-cal/node-cal.js 9999999');
  });

  it('should handle a month first route', function () {
    expect(parse('/cal/1/2015')).to.equal('./node-cal/node-cal.js 1 2015');
  });

  it('should handle a month last route', function () {
    expect(parse('/cal/2015/1')).to.equal('./node-cal/node-cal.js 1 2015');
  });
